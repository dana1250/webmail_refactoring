 ...
 * @author jongmin
 */
public class UserAdminHandler extends HttpServlet implements Serializable {
    ...
    private String getUserRegistrationSuccessPopUp() {
        ...
        StringBuilder successPopUp = new StringBuilder(300);
    ...
    private String getUserRegistrationFailurePopUp() {
        ...
        StringBuilder successPopUp = new StringBuilder(300); //InsufficientStringBufferDeclaration
        successPopUp.append("<html>");
        successPopUp.append("<head>");
